...
export default function HitachiList() {
    ...
    useEffect(() => {
        ...
        console.log("cookie Yapple ID: " + getCookie("city_id"))
        console.log("PPID:  " + getCookie("ppid"))
    ...
    const onClickReturn = () => {
        ...
        router.push({
            pathname: "https://login-portal-dev.biz.cityos-dev.hitachi.co.jp/select_service",
            target: '_blank'
        })
    }
                            ...
                            <div className={`p-2 w-12 text-center ${userProfile == 'yabu_cityworker' ? '' : 'mt-5 pt-5'}`}>
                                <div className=''>
                                    <Button buttonProps={{
                                        ...
                                        rounded: true,
                                        onClick: () => triggerPreRegisterConfirmation(yappleID)
                                    }} parentClass={"p-2"} />
