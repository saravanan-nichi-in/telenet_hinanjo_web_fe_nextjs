...
export default function EventAttendeesList() {
    ...
    const columnNames = [
        ...
        { field: "family_join_date", header: translate(localeJson, 'staff_attendees_table_checkin'), sortable: true, textAlign: 'left', alignHeader: "left", minWidth: "8rem", maxWidth: "8rem" },
        { field: "family_out_date", header: translate(localeJson, 'staff_attendees_table_checkout'), sortable: true, textAlign: 'left', alignHeader: "left", minWidth: "9rem", maxWidth: "9rem" }
    ];
