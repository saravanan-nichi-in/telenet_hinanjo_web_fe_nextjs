...
const AppMenuitem = (props) => {
    ...
    return (
        <li className={classNames({ 'layout-root-menuitem': props.root, 'active-menuitem': active })}>
            {props.root && item.visible !== false && <div className={classNames('layout-menuitem-root-text font-18', {'active-route': active})}><i className={classNames('layout-menuitem-icon font-18', item.icon)}></i><span className='layout-menuitem-root-span'>{item.label}</span></div>}
