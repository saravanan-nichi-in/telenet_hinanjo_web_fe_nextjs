                    ...
                    <div>
                            ...
                            <Accordion>
                                <AccordionTab header={`${translate(localeJson, 'item')} ${item.title}`}>
                                    ...
                                    <div className="" style={{
                                        ...
                                        <div className="col-fixed col-12 flex align-items-center justify-content-start"
                                            style={{
                                                borderLeft: "1px solid #000",
                                            }}
                                        >
                                        ...
                                        <div className='col-12 flex align-items-center justify-content-start' style={{
                                            borderLeft: "1px solid #000",
                                        }}>
                                            <Button buttonProps={{
                                                text: `－ ${translate(localeJson, 'del_item')}`,
                                                buttonClass: "del_ok-button w-8",
                                                rounded: "true",
                                                type: "button",
                                                onClick: () => removeQuestion()
                                            }} parentClass={"del_ok-button w-12"} />
                                        </div>
                                    </div>
                                            ...
                                            <div key={i} className="" style={{
                                                ...
                                                >
                                                    ...
                                                    {translate(localeJson, 'choice')} {i + 1}<span style={{
                                                        color: i == 0 ? "red" : "", display: i == 0 ? 'block' : 'none'
                                                    }} >*</span>
                                                ...
                                                <div className="col-12" style={{
                                                    ...
                                                    <div className='gap-1 pb-2 align-items-center'>
                                                        <Input inputProps={{
                                                            value: option,
                                                            inputClass: "w-full",
                                                ...
                                                <div className='col-12 flex align-items-center justify-content-start' style={{
                                                    ...
                                                    {item.option.length == i + 1 ? (
                                                        <Button buttonProps={{
                                                            ...
                                                            rounded: "true",
                                                            buttonClass: "create-button-questionnaire w-8",
                                                            type: "button",
                                                            onClick: () => updateFormChangeData(i, "add")
                                                        }} parentClass={"create-button-questionnaire w-12"}
                                                        />
                                                    ) : (
                                                        <Button buttonProps={{
                        ...
                        <div className='hidden sm:block'>
                            ...
                            <div className="flex " style={{
                                ...
                                <div className="col" style={{
                                    ...
                                    <div className='block md:flex lg:flex'>
                                        <div className='col-12 sm:col-12 md:col-2 lg:col-2 flex gap-2 align-items-center justify-content-start'>
                                            <NormalCheckBox checkBoxProps={{
                                                checked: item.is_required,
                                                onChange: (e) => updateFormChangeData(e.checked, "required")
                                            }} />
                                        ...
                                        <div className='col-12 sm:col-12 md:col-5 lg:col-5 flex  gap-2 align-items-center justify-content-start ' style={{ fontSize: "14px" }}>
                                            <InputSwitch inputSwitchProps={{
                                                checked: item.is_visible,
                                                onChange: (e) => updateFormChangeData(e.value, "visible")
                                            }} />
                                    ...
                                    <div className='block align-items-center justify-content-between'>
                                        ...
                                        <div className='col-12 sm:col-12 md:col-5 lg:col-5 custom-switch flex gap-2 align-items-center justify-content-start' style={{ paddingRight: "54px", fontSize: "14px" }}>
                                            <InputSwitch inputSwitchProps={{
                                                checked: item.is_voice_type,
                                                onChange: (e) => updateFormChangeData(e.value, "voice"),
                                                disabled: item.selected_type == 1 ? true : false
                            ...
                            <div className="flex" style={{
                                ...
                                <div className="col-fixed col-2 pl-0 pr-0 flex align-items-center justify-content-center">
                                    {translate(localeJson, 'item_title')}<span style={{
                                        color: "red"
                                    }}>*</span>
                                </div>
                                ...
                                <div className='col-3 pl-3 pr-3 flex align-items-center justify-content-center' style={{
                                    borderLeft: "1px solid #000",
                                }}>
                                    <Button buttonProps={{
                                        text: `－ ${translate(localeJson, 'del_item')}`,
                                        buttonClass: "del_ok-button w-12",
                                        rounded: "true",
                                        type: "button",
                                        onClick: () => removeQuestion()
                                    }} parentClass={"del_ok-button w-12"} />
                                    ...
                                    <div key={i} className="flex" style={{
                                        ...
                                        <div className='col-3 pl-3 pr-3 flex align-items-center justify-content-center' style={{
                                            ...
                                            {item.option.length == i + 1 ? (
                                                <Button buttonProps={{
                                                    text: `＋ ${translate(localeJson, 'add_choice')}`,
                                                    buttonClass: "create-button-questionnaire w-12",
                                                    rounded: "true",
                                                    type: "button",
                                                    onClick: () => updateFormChangeData(i, "add")
                                                }} parentClass={"create-button-questionnaire w-12 "}
    ...
    return (
        <>
            <div className="grid custom_orderlist">
                <div className="col-12 mt-3 question-block">
                    {itemTemplate(item)}
                </div>
            </div>
        </>
