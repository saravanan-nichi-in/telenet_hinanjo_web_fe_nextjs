...
import { groupData, tableDefaultPageSizeOption, fileName, groupMember } from "@/utils/constant";
      ...
      render: (text, record) => (
        <div>
          <p className="flex">
            ...
            >
              <center><SectionDeleteIcon /></center>
            </span>
          </p>
        </div>
      ),
    ...
    <>
      <div>
        <div className="flex justify-between mb-2 xl:mb-2 ">
          ...
          <div className="hidden lg:flex items-center">
            ...
            <span>
              <IconOutlineBtn
                text={intl.user_group_mongst_list_add_group}
                textColor={"text-customBlue"}
                textBold={true}
                py={"xl:py-[8px] md:py-1.5 py-1.5"}
        ...
        <div className="mb-[20px] relative" style={{ width: "102%" }}>
          <DataTable
            rowSelectionFlag
            columns={columns}
                  ...
                  <div className="flex flex-row">
                   <div className="basis-4/5">
                    <DropdownMedium
                      ...
                      padding={"pt-[12px] pb-[12px] pr-[120px]"}
                      options={[
                        { id: 1, value: "1", label: "000*000*0001" },
                        { id: 2, value: "2", label: "000*000*0002" },
                        { id: 2, value: "2", label: "000*000*0003" },
                        { id: 2, value: "2", label: "000*000*0004" },
                        { id: 2, value: "2", label: "000*000*0005" },
                      ]}
                      keys={"value"} // From options array
                      optionLabel={"label"} // From options array
                      border={"border border-gray-300"}
      ...
      {(detailsModal || editModal) && (
        <Modal
          ...
          fontWeight="font-semibold"
          textColor="#346595"
          text={detailsModal ? "グルプの詳細" : "グループの編集"}
          onCloseHandler={setAddNewModal}
                ...
                <div className="flex flex-row mb-2">
                   <div className="w-full">
                      <label
                        ...
                        style={{ color: "#7B7B7B" }}
                      >
                        {"グループメンバー"}{!detailsModal && <span style={{color:"red"}}> *</span>}
                      </label>
                   </div>
                   <div className="basis">
                    {!detailsModal && <IconBtn
                      textColor={"text-white"}
                      textBold={true}
                      icon={() => {
                        return <FaPlus/>
                      }}
                      additionalClass={"py-[2px] px-[2px] ml-3"}
                      bg="bg-customBlue"
                      onClick={() => {}}
                    />}
                   </div>
                        ...
                        <nav className="group-member-class">
                            <ul>
                                {groupMember.map((member,index)=>{
                                  return <li className="pr-1 my-2" key={member.id} id={index}>
                                    <span>{member.name}</span>
                                    {!detailsModal && <span className="float-right cursor-pointer">
                                      <SectionDeleteIcon />
                                    </span>}
                                  </li>
                                })}
